...
annotations = {
    ...
    'minicsd_precomp':['train_caps.txt','dev_caps.txt'],
    'minicsdv2_precomp':['train_caps.txt','dev_caps.txt'],
    'csd':['filtered_caps_test.txt','filtered_caps_train.txt'],
    ...
    'text2art_precomp':['descfile_train.txt','descfile_test.txt','descfile_val.txt'],
}
...
def from_flickr_json(path):
    dataset = json.load(open(path, 'r', encoding='utf-8'))['images']
    captions = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', default='minicsdv2_precomp',
